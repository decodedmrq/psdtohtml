<div class="sidebar sidebar-dark">
    <div class="sidebar-content">
        ...
        <ul class="sidebar-menu sm-condensed" data-toggle="sidebar-collapse">
            <li class="sidebar-menu-item {{ html_helper()->active('admin.dashboard') }}">
            ...
            <li class="sidebar-menu-item {{ html_helper()->active('admin.feedback') }}">
                <a class="sidebar-menu-button" href="{{ route('admin.feedback') }}">
                    <i class="sidebar-menu-icon material-icons">feedback</i> {{trans('labels.feedback')}}
                </a>
            </li>
