...
<section class="intro container-part row" name="content">
    ...
    <div class="part-body col-md-12">
        <article class="row">
            <header class="title col-md-5 pr-0">
                <h4 class="mb-0"> Phương pháp học Nhân tướng</h4>
                <h4 class="mb-0"> tốt nhất hiện nay </h4>
            </header>
            ...
            <div class="content col-md-7 pull-md-5">
                ...
                <div class="text-center">
                    <div class="btn-tgl-content btn btn-outline-secondary"
                         data-toggle="info-tgl-content">
